    ...
    <div class="main-box">
        ...
        <div :class="['container', 'container-login', { 'is-txl is-z200': isLogin }]">
            <form>
                ...
                <span class="text">or use email for registration</span>
                <input class="form__input" v-model="loginForm.username" type="text" placeholder="username" />
                <input class="form__input" v-model="loginForm.password" type="password" placeholder="Password" />
